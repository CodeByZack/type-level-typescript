...
让我们练习一下！如果您还没有准备好，请查看上一章中的[“挑战如何工作”](/01-types-and-values#how-challenges-work)部分，了解如何应对这些挑战。

<CodeEditor height={480} defaultValue={[typeAreDataPracticeArr[0],typeAreDataPracticeArr[1]]} />
<CodeEditor height={480} defaultValue={[typeAreDataPracticeArr[2],typeAreDataPracticeArr[3]]}  />
<CodeEditor height={480} defaultValue={[typeAreDataPracticeArr[4],typeAreDataPracticeArr[5]]} />
<CodeEditor height={480} defaultValue={[typeAreDataPracticeArr[6],typeAreDataPracticeArr[7]]} />
<CodeEditor height={480} defaultValue={[typeAreDataPracticeArr[8],typeAreDataPracticeArr[9]]} />
<CodeEditor height={480} defaultValue={[typeAreDataPracticeArr[10],typeAreDataPracticeArr[11]]} />
